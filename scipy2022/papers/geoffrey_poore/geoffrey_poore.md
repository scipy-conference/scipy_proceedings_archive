...
[^rstudio-visual]: The RStudio editor is unique in also offering a Pandoc-based visual editing
...
[^commonmark-x-roadmap]: The Pandoc Roadmap at <https://github.com/jgm/pandoc/wiki/Roadmap> summarizes
...
[^intersection-observer]: For technical details, <https://www.w3.org/TR/intersection-observer/>.  For
    an overview,
